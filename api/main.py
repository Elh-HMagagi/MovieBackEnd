...
# ----Dependance pour la session de la base de donnees
def get_db():
    db=SessionLocal()
    try:
        yield db
...
# ---- End point test de fonctionnement de l api
@app.get(
    "/",
    summary="Verifation du fonctionnement de l API",
    description = "Verifie que l API fonctionne correctement",
    operation_id = "healt_check_movies_api",
    tags =["monotoring"]
)
async def root():
